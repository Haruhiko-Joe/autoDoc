...
1. Your company / legal entity name and website.
2. Approximate team size or headcount.
3. Intended use case (internal tool / embedded in product / SaaS / other).
4. Expected number of deployments or users.
5. Any specific legal requirements (warranty, indemnity, audit rights, etc.).

A quote and draft agreement will be sent back within a few business days.

---

## Notes for legal / compliance teams
...
- The Licensor is the sole copyright holder of the original work. External
  ...
  offer this dual-licensing arrangement.
- Technical artifacts delivered under the commercial license are byte-identical
  to the public AGPL-3.0 release of the same version, unless otherwise agreed.
  The commercial license is a legal instrument, not a separate build.
